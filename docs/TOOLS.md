...
- **Auth**: keyless — ecosyste.ms needs no API key (5,000 req/hour anonymous rate limit). Set `ECOSYSTEMS_API_KEY` (free, register at [ecosyste.ms/login](https://ecosyste.ms/login)) to raise the limit.
