...
| `awesome_list_search` | **[ecosyste.ms](https://ecosyste.ms/)** | Community-curated "awesome list" discovery by topic — stars, project counts, archived status | No |
...
**Notes:**
- World Bank, OECD, Eurostat, ClinicalTrials.gov, CourtListener, and ecosyste.ms are always available — no configuration required.
