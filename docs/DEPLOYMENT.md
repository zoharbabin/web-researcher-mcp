...
| `OPEN_SYLLABUS_API_KEY` + `OPEN_SYLLABUS_API_URL` | `syllabus_search` | Research-agreement credentials for the Open Syllabus Project API (contact@opensyllabus.org). Both must be set or the tool does not register | — |
