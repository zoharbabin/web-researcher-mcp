...
type webSearchInput struct {
	...
	Provider     string   `json:"provider,omitempty" jsonschema:"Choose which search engine to use for this query: google, brave, serper, searxng, searchapi, duckduckgo, tavily, exa, hackernews, reddit, github. Leave empty to use the default. Returns an error if the chosen provider isn't set up."`
