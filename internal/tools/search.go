...
type webSearchInput struct {
	...
	Country      string   `json:"country,omitempty" jsonschema:"Bias results toward a country using ISO 3166-1 alpha-2 code (e.g. US, GB). Localization strength is provider-dependent: it shifts ranking toward local results, it does not guarantee every result originates from that country."`
